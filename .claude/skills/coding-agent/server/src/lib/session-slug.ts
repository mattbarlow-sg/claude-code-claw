...
const SLUG_NOUNS = [
  ...
  "cloud", "comet", "coral", "cove", "crest", "daisy", "dune", "ember",
  "falcon", "fjord", "forest", "glade", "gulf", "harbor", "haven", "kelp",
  "lagoon", "meadow", "mist", "nexus", "ocean", "orbit", "otter", "pine",
  "prairie", "reef", "ridge", "river", "rook", "sable", "sage", "shell",
  "shoal", "shore", "summit", "trail", "valley", "wharf", "willow", "zephyr",
];
